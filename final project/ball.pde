...
class Ball {
  ...
  void bounce() {
    ...
    if (abs(velocity.y) >= 0.4) {
      ...
      //play music
      //players[music].setGain(0);
      players1[music].play();
       players1[music].shiftGain(players1[music].getGain(),-20,2500);
      players1[music].rewind();
      musics.add(new Music(music,millis()));
