...
public class PictureFill{
    ...
    public void IniPictureFill( PVector tSizeImg, PVector tShowStart ){
    ...
    public void Update( ArrayList<PVector> tAddPixel ){
        FillPixel( tAddPixel );
        //ShowImg();
    }
    public void FillPixel( ArrayList<PVector> tAddPixel ){
